...
PERSONA_COUNTRIES = [
    "Estados Unidos", "Reino Unido", "Canada", "Australia", "Alemania",
    "Francia", "Mexico", "Brasil", "Espana", "Argentina",
]

PERSONA_AGE_RANGES = ["18-24", "25-34", "35-44", "45-54", "55-64"]

PERSONA_OCCUPATIONS = [
    "Marketer junior", "Lider de crecimiento", "Founder", "Creador fitness",
    "Comprador de medios", "Estratega freelance", "Community manager",
    "Disenador de marca", "Operador comercial", "Emprendedor estudiante",
]

PERSONA_INCOME_BRACKETS = ["$25k-$50k", "$50k-$90k", "$90k-$140k", "$140k-$220k"]

PERSONA_SOCIAL_STATUS = [
    "Estudiante", "Profesional joven", "Profesional consolidado", "Dueno de negocio",
]
